...
const positioningRequirements = {
  ...
  'cv/index.html': [
    ...
    'Gas-turbine engine performance, systems integration & technical authority',
    'CEng · Gas Turbines · Industrial AI/ML',
    'Gas-turbine engine performance, systems integration, experimental validation, diagnostics, industrial imaging, AI/ML and research translation',
